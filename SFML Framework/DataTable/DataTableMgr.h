...
#define DECK_TABLE (DATATABLE_MGR.Get<DeckTable>(DataTable::Types::Deck))
#define VILLAGER_TABLE (DATATABLE_MGR.Get<VillagersTable>(DataTable::Types::Villagers))
#define COMBINE_TABLE (DATATABLE_MGR.Get<CombineTable>(DataTable::Types::Combine))
